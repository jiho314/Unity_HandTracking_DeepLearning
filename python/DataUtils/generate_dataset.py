...
def generate_dataset(rawdata_root="Data", target_root="Dataset", vfold_ratio=0.2, max_samples_per_class=5000):
    """
    args:
    ...
    print("*"*50)
    with open("Data/txtfiles/class_names", 'w') as f:
...
if __name__ == '__main__':
    ...
    generate_dataset(rawdata_root='Data', target_root='Dataset', vfold_ratio=0.2, max_samples_per_class=5000)